...
class Woocommerce_Product_Attachment
{
    ...
    private function define_admin_hooks()
    {
		...
		$this->loader->add_action( 'plugin_row_meta', $plugin_admin, 'wcpoa_plugin_row_meta',10,2 );
    ...
    public function plugin_action_links($actions, $plugin_file, $plugin_data, $context)
    {
        $custom_actions = array(
            ...
            'premium'   => sprintf('<a href="%s" target="_blank" style="color: rgba(10, 154, 62, 1); font-weight: bold; font-size: 13px;">%s</a>', 'https://www.thedotstore.com/woocommerce-product-attachment', __('Upgrade To Pro', $this->plugin_name))
        );
